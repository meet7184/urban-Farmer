              ...
              builder: (LoginController controller) {
                return Column(
                  children: [
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 40),
                          OtpTextField(controller: loginOtpController),
                          const SizedBox(height: 40),
                          GestureDetector(
                            onTap: () async {
                              disposeKeyboard();
                              if (loginOtpController.text.length == 4) {
                                context.loaderOverlay.show();
                                final response =
                                    await controller.loginOtpVerification(
                                        loginOtpController.text.trim());
                    ...
                    SizedBox(height: 30),
                    Spacer(),
                    Image.asset(AppAssets.otpImag, height: 282),
                  ],
                );
              },
            ),
